@extends('layouts.app')
@section('content')
<h1 class="text-xl font-bold mb-4">Add Stock Out</h1>
<form method="POST" action="{{ route('stock-outs.store') }}" class="bg-white p-6 rounded shadow max-w-md mx-auto">
    @csrf
    <div class="mb-4">
    ...
    <a href="{{ route('stock-outs.index') }}" class="ml-2 text-gray-600">Cancel</a>
</form>
@endsection
